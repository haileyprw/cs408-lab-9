...
// Create a reference to the paragraph element that displays the ball count
const ballCountParagraph = document.getElementById('ballCount');

// Variable to keep track of the number of balls
let ballCount = 0;
let winPossible = false;

// Function to update the ball count display
function updateBallCount() {
  ballCountParagraph.textContent = `Balls on screen: ${ballCount}`;
}
...
function loop() {
  ...
  if (winPossible == true && ballCount == 0) {
